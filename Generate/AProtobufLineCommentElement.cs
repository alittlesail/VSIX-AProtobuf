...
namespace ALittle
{
	public class AProtobufLineCommentElement : ABnfNodeElement
	{
		public AProtobufLineCommentElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
