...
namespace ALittle
{
	public class AProtobufCustomTypeElement : ABnfNodeElement
	{
		public AProtobufCustomTypeElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
