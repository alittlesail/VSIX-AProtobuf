...
namespace ALittle
{
	public class AProtobufBoolElement : ABnfNodeElement
	{
		public AProtobufBoolElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
