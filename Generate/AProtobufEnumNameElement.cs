...
namespace ALittle
{
	public class AProtobufEnumNameElement : ABnfNodeElement
	{
		public AProtobufEnumNameElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
