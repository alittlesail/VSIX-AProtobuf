...
namespace ALittle
{
	public class AProtobufMessageNameElement : ABnfNodeElement
	{
		public AProtobufMessageNameElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
