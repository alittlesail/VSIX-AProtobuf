...
namespace ALittle
{
	public class AProtobufEnumOptionElement : ABnfNodeElement
	{
		public AProtobufEnumOptionElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
