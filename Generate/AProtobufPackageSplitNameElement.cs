...
namespace ALittle
{
	public class AProtobufPackageSplitNameElement : ABnfNodeElement
	{
		public AProtobufPackageSplitNameElement(ABnfFactory factory, ABnfFile file, int line, int col, int offset, string type)
